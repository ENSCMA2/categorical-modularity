...
from_train_x = load(lang + "from_english_en_translationsubsvecstrain.txt", 5000)
from_train_y = load(lang + "from_english_" + lang + "_translationsubsvecstrain.txt", 5000)
from_test_x = load(lang + "from_english_en_translationsubsvecstest.txt", 1500)
from_test_y = load(lang + "from_english_" + lang + "_translationsubsvecstest.txt", 1500)

to_train_y = load(lang + "to_english_en_translationsubsvecstrain.txt", 5000)
to_train_x = load(lang + "to_english_" + lang + "_translationsubsvecstrain.txt", 5000)
to_test_y = load(lang + "to_english_en_translationsubsvecstest.txt", 1500)
to_test_x = load(lang + "to_english_" + lang + "_translationsubsvecstest.txt", 1500)
