...
englishmodel = fasttext.load_model("wiki.en.bin")
...
with open(train_to_files[i], "r") as words:
  ...
  with open(lang + "to_english_" + lang + "_translationftvecstrain.txt", "w") as o:
    for v in tgt_vectors:
      o.write(str(list(v)) + "\n")
  with open(lang + "to_english_en_translationftvecstrain.txt", "w") as o:
...
with open(test_to_files[i], "r") as words:
  ...
  tgt_vectors = [model[tgt_wds[i]] for i in range(len(tgt_wds))]
  eng_vectors = [englishmodel[eng_wds[i]] for i in range(len(eng_wds))]
  with open(lang + "to_english_" + lang + "_translationftvecstest.txt", "w") as o:
    for v in tgt_vectors:
      o.write(str(list(v)) + "\n")
  with open(lang + "to_english_en_translationftvecstest.txt", "w") as o:
    for v in eng_vectors:
      o.write(str(list(v)) + "\n")
...
with open(train_from_files[i], "r") as words:
  ...
  tgt_vectors = [model[tgt_wds[i]] for i in range(len(tgt_wds))]
  eng_vectors = [englishmodel[eng_wds[i]] for i in range(len(eng_wds))]
  with open(lang + "from_english_" + lang + "_translationftvecstrain.txt", "w") as o:
    for v in tgt_vectors:
      o.write(str(list(v)) + "\n")
  with open(lang + "from_english_en_translationftvecstrain.txt", "w") as o:
    for v in eng_vectors:
      o.write(str(list(v)) + "\n")
...
with open(test_from_files[i], "r") as words:
  ...
  tgt_vectors = [model[tgt_wds[i]] for i in range(len(tgt_wds))]
  eng_vectors = [englishmodel[eng_wds[i]] for i in range(len(eng_wds))]
  with open(lang + "from_english_" + lang + "_translationftvecstest.txt", "w") as o:
    for v in tgt_vectors:
      o.write(str(list(v)) + "\n")
  with open(lang + "from_english_en_translationftvecstest.txt", "w") as o:
    for v in eng_vectors:
      o.write(str(list(v)) + "\n")
