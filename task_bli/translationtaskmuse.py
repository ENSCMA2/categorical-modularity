...
from_train_x = load(lang + "from_english_en_translationmusevecstrain.txt", 5000)
from_train_y = load(lang + "from_english_" + lang + "_translationmusevecstrain.txt", 5000)
from_test_x = load(lang + "from_english_en_translationmusevecstesttxt", 1500)
from_test_y = load(lang + "from_english_" + lang + "_translationmusevecstest.txt", 1500)

to_train_y = load(lang + "to_english_en_translationmusevecstrain.txt", 5000)
to_train_x = load(lang + "to_english_" + lang + "_translationmusevecstrain.txt", 5000)
to_test_y = load(lang + "to_english_en_translationmusevecstest.txt", 1500)
to_test_x = load(lang + "to_english_" + lang + "_translationmusevecstest.txt", 1500)
